...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          15, NORMAL,        PHYSICAL, 100, 10,   0
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          18, NORMAL,        PHYSICAL, 100, 15,   0
	move MEGA_PUNCH,   EFFECT_NORMAL_HIT,         80, FIGHTING,      PHYSICAL, 100, 20,   0
	...
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,        100, FLYING,        SPECIAL,  100, 10,   0
	...
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         45, GRASS,         PHYSICAL, 100, 10,   0
	move STOMP,        EFFECT_STOMP,              65, NORMAL,        PHYSICAL, 100, 20,  30
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         45, FIGHTING,      PHYSICAL, 100, 30,   0
	...
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         60, FIGHTING,      PHYSICAL, 100, 15,  30
	...
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, NORMAL,        PHYSICAL, 100, 20,   0
	...
	move THUNDER,      EFFECT_THUNDER,           120, ELECTRIC,      SPECIAL,   85, 10,  30
	...
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, NORMAL,        PHYSICAL, 100, 10,   0
	move LICK,         EFFECT_PARALYZE_HIT,       50, GHOST,         PHYSICAL, 100, 30,  30
	move SMOG,         EFFECT_POISON_HIT,         40, POISON,        SPECIAL,  100, 20,  40
	...
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         100, FIGHTING,      PHYSICAL,  90, 20,   0
	move GLARE,        EFFECT_PARALYZE,            0, NORMAL,        STATUS,    75, 30,   0
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, PSYCHIC_TYPE,  SPECIAL,  100, 15,   0
	move POISON_GAS,   EFFECT_POISON,              0, POISON,        STATUS,   100, 40,   0
	move BARRAGE,      EFFECT_MULTI_HIT,          15, NORMAL,        PHYSICAL,  95, 20,   0
	...
	move FLASH,        EFFECT_ACCURACY_DOWN_HIT,  40, ELECTRIC,      SPECIAL,  100, 20,   0
	move PSYWAVE,      EFFECT_PSYWAVE,             1, PSYCHIC_TYPE,  SPECIAL,   90, 15,   0
	...
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          18, NORMAL,        PHYSICAL,  95, 15,   0
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        25, FIGHTING,      PHYSICAL, 100, 10,   0
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  40, GROUND,        SPECIAL,  100, 10,  50
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,         SPECIAL,   90, 10,  50
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,        STATUS,   100, 20,   0
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      100, ELECTRIC,      SPECIAL,   80,  5, 100
	...
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          90, GRASS,         SPECIAL,  100,  5,   0
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     80, STEEL,         PHYSICAL, 100, 25,  50
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       100, FIGHTING,      PHYSICAL,  80,  5, 100
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,         PHYSICAL, 100, 15,  30
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      50, STEEL,         PHYSICAL, 100, 35, 100
	...
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,      PHYSICAL, 100,  5,   0
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         90, ROCK,          SPECIAL,  100,  5,  10
	...
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        80, WATER,         SPECIAL,   90, 15,   0
